...
const TEMPLATES: TemplateDef[] = [
  {
    ...
    layout: {
      ...
      location:    { x: 480, y: 500, w: 520, fontSize: 30 },
      salary:      { x: 480, y: 520, w: 520, fontSize: 28 },
      description: { x: 480, y: 580, w: 520, h: 80, fontSize: 18 },
      benefits:    { x: 480, y: 700, w: 520, h: 260, fontSize: 24 },
      email:       { x: 750, y: 1000, w: 200, fontSize: 20, align: 'left' },
      phone:       { x: 750, y: 1010, w: 200, fontSize: 20, align: 'left' },
  ...
  },
  {
    ...
    layout: {
      ...
      email:      { x: 860, y: 940, w: 200, fontSize: 20, align: 'right' },
      phone:      { x: 860, y: 980, w: 200, fontSize: 20, align: 'right' },
