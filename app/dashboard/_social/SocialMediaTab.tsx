...
const TEMPLATES: TemplateDef[] = [
  {
    ...
    height: 1080,
    layout: {
      title:       { x: 420, y: 360, w: 560, fontSize: 72 },
      location:    { x: 470, y: 450, w: 520, fontSize: 30 },
      salary:      { x: 470, y: 510, w: 520, fontSize: 28 },
      description: { x: 470, y: 550, w: 520, h: 80, fontSize: 18 },
      benefits:    { x: 470, y: 600, w: 520, h: 260, fontSize: 24 },
