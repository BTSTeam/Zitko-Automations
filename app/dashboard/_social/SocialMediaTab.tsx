...
const TEMPLATES: TemplateDef[] = [
  {
    ...
    layout: {
      ...
      location:    { x: 510, y: 460, w: 520, fontSize: 30 },
      salary:      { x: 510, y: 520, w: 520, fontSize: 28 },
      description: { x: 510, y: 580, w: 520, h: 80, fontSize: 18 },
      benefits:    { x: 510, y: 700, w: 520, h: 260, fontSize: 24 },
      email:       { x: 800, y: 970, w: 180, fontSize: 20, align: 'left' },
